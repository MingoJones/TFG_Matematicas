...
\input{./elementos/resto/Z-portada-interior.tex}
\newpage
\ %Incluir pagina en blanco
\onehalfspace
\chapter*{Declaración de originalidad}
\thispagestyle{empty}
\input{elementos/resto/Z-declaracion-originalidad.tex}
\newpage
\ %Incluir pagina en blanco
...
%\frontmatter
%\chapter*{}
%\input{./elementos/resto/Z-fraseculterana.tex}
%-------------------------------------------------------------------
%	DEDICATORIA
%-------------------------------------------------------------------
%\pagestyle{empty}
%ESTO VAN A SER LOS AGRADECIMIENTOS
\chapter*{}
\thispagestyle{empty}
\input{./elementos/resto/Z-dedicatoria.tex}
\newpage
\ %Incluir pagina en blanco
%-------------------------------------------------------------------
%	AGRADECIMIENTOS
...
%-------------------------------------------------------------------
%\chapter*{Prefacio}
%\input{./elementos/resto/Z-prefacio.tex}
...
\input{./elementos/resto/Z-abstract.tex}
\chapter*{Resumen}
\addcontentsline{toc}{chapter}{Resumen}
\input{./elementos/resto/Z-resumen.tex}
...
\definecolor{ggcol}{rgb}{0,0,1.}   % Blue
\newcommand{\gu}[1]{{\color{ggcol}{[G: #1]}}}
...
\input{./elementos/capitulo1/capitulo1.tex}

\chapter{Caracterizaciones de la equidistribución}
\input{./elementos/capitulo2/capitulo2.tex}

\chapter{Método de Euler}
\input{./elementos/capitulo3/capitulo3.tex}

\chapter{Método de Van der Corput}
\input{./elementos/capitulo4/capitulo4.tex}
...
\addtocontents{toc}{\vspace{1em}} % Agrega espacios en la toc
\appendix % Los siguientes capítulos son apéndices

\chapter{Demostraciones técnicas}\label{Apendice_A}
\input{./elementos/apendices/apendice1.tex}

\chapter{Resultados de análisis}\label{Apendice_B} 
\input{./elementos/apendices/apendice2.tex}
...
\addtocontents{toc}{\vspace{1em}} % Agrega espacio en la toc
\end{document}
