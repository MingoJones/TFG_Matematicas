\begin{theorem}
    ...
    Sea $(x_n)_{n\geq1}$ una sucesión de números reales. Si para cada $h=1,2,...$
    la sucesión $\partfrac{x_{n+h}-x_n}$ es equidistribuida en $[0,1)$, 
    entonces la sucesión $\partfrac{x_n}$ es equidistribuida en $[0,1)$.
\end{theorem}
...
\begin{proof}
    ...
    Dado que para cada $h=1,2,...$ la sucesión $\partfrac{x_{n+h}-x_n}$ es equidistribuida en $[0,1)$, por el criterio de Weyl se tiene que
    \[
    ...
    Por lo tanto, por el criterio de Weyl, la sucesión $\partfrac{x_n}$ es equidistribuida en $[0,1)$.
\end{proof}
