\begin{lemma}
    ...
    Sean $H,N \in \mathbb{N}$ y $1 \leq H \leq N$ entonces,
    \begin{align}
...
\begin{proof}
    ...
    como $p=2,\dots,N+H$ y $s=2,\dots,H$ entonces $n=0,\dots,N$. Además, como la suma es 
    finita podemos cambiar el orden de los sumatorios,
    \[
    ...
    Tomando las acotaciones $N+H-1 \leq 2N$, $H-h \leq H$ y $\operatorname{Re}(z) \leq |z|$ 
    para todo $z \in \mathbb{C}$. Además, teniendo en cuenta que $u_n = 0$ para $n > N$ y 
    para $n \leq 0$, se obtiene,
    \[
