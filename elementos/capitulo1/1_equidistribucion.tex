\begin{definition}
    Sea $(x_n)_{n\geq1}$ una sucesión de números reales. Decimos que $(x_n)$ es
    equidistribuida módulo $1$ o equidistribuida en $\mathbb{T}$ si para cada
...
\begin{remark}
    ...
    \[
        ...
        \int_\mathbb{T} \mathbf{1}_{(a,b)}(x)\ dx = 
        b-a
    \]
\end{remark}