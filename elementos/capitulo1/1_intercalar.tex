\begin{example}
    Sean $x=(x_n)_{n\geq1}, y=(y_n)_{n\geq1}$ dos sucesiones equidistribuidas módulo $1$.
    Entonces la sucesión $z=(z_n)_{n\geq1}$ dada por
    \[
        z_n = \begin{cases}
            x_k & \text{si } n = 2k-1,\\
            y_k & \text{si } n = 2k,
...
\begin{resolve}
    Sea un intervalo $(a,b)\subset \mathbb{T}$ con $0<a<b<1$. Consideremos $2N$ términos de la sucesión $(z_n)$, 
    \[
