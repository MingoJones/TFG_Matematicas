\begin{proposition}
    ...
    Sea $(x_n)_{n\geq1}$ una sucesión equidistribuida módulo $1$
    y sea $\alpha \in \mathbb{R}$. Entonces la sucesión
    \[
        y_n = x_n + \alpha
    \]
...
\begin{proof}
    Sea un intervalo $I \subseteq \mathbb{T}$, definimos $J = I - \alpha \mod 1$.
