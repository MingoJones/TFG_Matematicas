\begin{proposition}
    ...
    Sea $x=(x_n)_{n\geq1}$ una sucesión equidistribuida módulo $1$ y sea $\alpha \in \mathbb{R}$. 
    Entonces la sucesión $y=(y_n)_{n\geq1}$ dada por $y_n = x_n + \alpha$ también es equidistribuida módulo $1$.
\end{proposition}
