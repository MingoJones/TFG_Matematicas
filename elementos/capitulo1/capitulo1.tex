...
Este capítulo se basa principalmente en el libro de Stein y Shakarchi 
\cite[Capítulo 4, Sección 2]{stein-2003}. Exploraremos los conceptos básicos para estudiar este tipo 
...
\input{elementos/capitulo1/1_partes_defs.tex}
...
\begin{remark}
    Las funciones en $\mathbb{T}$ son funciones $1$-periódicas en $\mathbb{R}$. Es decir, si $f:\mathbb{T}\to\mathbb{R}$, entonces podemos extender $f:\mathbb{R}\to\mathbb{C}$ mediante
    \[
        f(x+1) = f(x) \quad \text{ para todo } x \in \mathbb{R},
    \]
    y viceversa. Debido a esta periodicidad, tenemos que $f(x) = f(\partfrac{x})$ para todo $x \in \mathbb{R}$,
    por lo que podemos considerar a $f$ como una función definida en $\mathbb{T}=[0,1)$.
\end{remark}

\section{Equidistribución de sucesiones}

\input{elementos/capitulo1/1_equidistribucion.tex}
...
\input{elementos/capitulo1/1_equidistribucion_equivalentes.tex}

\input{elementos/capitulo1/1_quitar_terminos.tex}

\input{elementos/capitulo1/1_secuencia_mas_const.tex}

\input{elementos/capitulo1/1_ejemplo_noeq.tex}

\input{elementos/capitulo1/1_ejemplo_sieq.tex}  

\input{elementos/capitulo1/1_intercalar.tex}
...
\input{elementos/capitulo1/1_periodicidad.tex}
...
este resultado, haremos uso del siguiente lema.

\input{elementos/capitulo1/1_lema.tex}

\input{elementos/capitulo1/1_teorema_na.tex}
