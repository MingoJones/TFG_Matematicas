...
\section{Los números reales módulo 1}
...
\begin{remark}
    ...
    por lo que podemos pensar en $f$ como una función definida en $\mathbb{T}$.
\end{remark}
...
La siguiente proposición nos permite utilizar cualquier tipo de intervalo para
...
este resultado, necesitamos el siguiente lema.
