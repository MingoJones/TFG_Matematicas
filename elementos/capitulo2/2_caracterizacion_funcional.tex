...
\begin{proof}
    ...
    $2 \Longrightarrow 1$ \, Sea un intervalo $(a,b) \subset \mathbb{T}$ con $0<a<b<1$ y sea $f(x) = \mathbf{1}_{(a,b)}(x)$, 
    dado que $f$ es Riemann integrable,
    \[
...
\begin{proof}
    $1 \Longrightarrow 2$ \, Es inmediato por el Teorema~\ref{carac:riemann} ya que $C(\mathbb{T}) \subset \mathcal{R}(\mathbb{T})$.

    $2 \Longrightarrow 1$ \, La demostración es análoga a la del Teorema \ref{teo:teorema_na}.
\end{proof}