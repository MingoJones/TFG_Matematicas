...
El siguiente resultado es un ejercicio en el libro \cite[Ejercicios 1.1-1.5]{kuipers-1974}, cuya demostración incluimos aquí por completitud.
...
\begin{proof}
    ...
    \[
        ...
        (a,b] = (a,b) \cup \{b\}.
    \]
    En consecuencia, la igualdad (\ref{def:equidistribucion}) se cumple para estos intervalos.
    ...
    \[
        \lim_{N \to \infty} \frac{\card \left\{1\leq n \leq N :\partfrac{x_n}=c\right\}}{N} = 0.
    \]
    Teniendo en cuenta la descomposición se obtiene la igualdad para intervalos de la forma $(a,b)$.
