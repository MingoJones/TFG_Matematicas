...
La demostración y desarrollo puede leerse en \cite{korner-2022}.
...
\begin{definition}
    ...
    \[
        J_v(x) = \frac{1}{2\pi} \int_{0}^{2\pi} e^{ix\sin(\theta)} e^{-in\theta} d\theta, \quad x\in\mathbb{R}.
    \]
\end{definition}
Esta función la utilizamos en el Ejemplo \ref{ex:sin_noeq}, con los valores $v=0$ y $x=2\pi$.

Para más información sobre la función de Bessel, consultar el Apéndice B de \cite{grafakos-2014}.
